...
#  Part of the R package, https://www.R-project.org
#
#  Copyright (C) 1995-2018, 2020 The R Core Team
#
#  This program is free software; you can redistribute it and/or modify
#  it under the terms of the GNU General Public License as published by
#  the Free Software Foundation; either version 2 of the License, or
...
## Finally (2008-02) made deprecated formally for 2.7.0, defunct in 2.8.0 -- removed for 4.0.0 --
...
## Deprecated in 2.7.0, defunct in 2.8.0 -- removed for 4.0.0 ----------------------
...
## Deprecated in 2.8.0, defunct in 2.9.0 -- removed in 4.0.0 ----------------------
             ...
             doCheck = TRUE)
{
    ...
    if (attach) {
        ...
        for(cl in classes) {
            if(lev > 2L) message("--- caching class ", sQuote(cl))
